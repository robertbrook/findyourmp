...
#{@line_3}"
    ...
    it 'should create constituencies' do
      ...
      list.items = @items
      list.constituencies.size.should == 3
      list.constituencies.should have_key(@line_1)
      list.constituencies.should have_key(@line_2)
      list.constituencies.should have_key(@line_3)
      list.constituencies[@line_1].should == [@constituency_1, nil]
      list.constituencies[@line_2].should == [@constituency_2, @constituency_3]
      list.constituencies[@line_3].should == nil

      list.constituencies.first.should == [@line_3, nil]
    end
